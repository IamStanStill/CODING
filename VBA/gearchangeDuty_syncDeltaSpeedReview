...
'       inputN = (syncDeltaSpeed + (OutputN * (35/11) * (39/28))) / (18/52)
'
'2  syncDeltaSpeed = (InputN * (22/46)) - (OutputN * (35/11) * (39/28))
'       inputN = (syncDeltaSpeed + (OutputN * (35/11) * (39/28))) / (22/46)
'
'3  syncDeltaSpeed = (InputN * (27/43)) - (OutputN * (35/11) * (39/28))
'       inputN = (syncDeltaSpeed + (OutputN * (35/11) * (39/28))) / (27/43)
'
...
For i = firstRow To lastRow
    ...
    If shiftType = "Track" Then
        ...
        If syncDeltaSpeed < 800 And syncDeltaSpeed > -800 Then
            ...
            If gear = 1 Then
                outputN_ = 500
                inputN_ = (syncDeltaSpeed_ + (outputN_ * (35 / 11) * (39 / 28))) / (18 / 52)
            
            ElseIf gear = 2 Then
                outputN_ = 750
                inputN_ = (syncDeltaSpeed_ + (outputN_ * (35 / 11) * (39 / 28))) / (22 / 46)
            
            ElseIf gear = 3 Then
                outputN_ = 1000
                inputN_ = (syncDeltaSpeed_ + (outputN_ * (35 / 11) * (39 / 28))) / (27 / 43)
